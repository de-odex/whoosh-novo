...
def test_vpst_block_tag():
    ...
    content = [
        "",
        "του δε ελεφαντος την τιγριν πολλον τι αλκιμωτερην \nΙνδοι αγουσι. ",  # noqa: RUF001
        "επεαν γαρ ομου ελθη ελεφαντι, επιπηδαν \nτε επι την κεφαλην του ελ",  # noqa: RUF001
        "ταυτας δε, αστινας και ημεις ορεομεν και \nτιγριας καλεομεν, θωας ",  # noqa: RUF001
        "επει και υπερ των μυρμηκων λεγει \nΝεαρχος μυρμηκα μεν αυτος ουκ ι",  # noqa: RUF001
        "Μεγασθενης δε ατρεκεα \nειναι υπερ των μυρμηκων τον λογον ιστορεει",  # noqa: RUF001
        "εκεινους δε  ειναι γαρ\nαλωπεκων μεζονας  προς λογον του μεγαθεος ",  # noqa: RUF001
        "αλλα Μεγασθενης\nτε ακοην απηγεεται, και εγω οτι ουδεν τουτου ατρε",
        "σιττακους δε Νεαρχος μεν ως δη τι\nθωμα απηγεεται οτι γινονται εν ",  # noqa: RUF001
        "εγω δε οτι αυτος τε πολλους οπωπεα και αλλους \nεπισταμενους ηδεα ",  # noqa: RUF001
        "και οφιας δε λεγει Νεαρχος \nθηρευθηναι αιολους μεν και ταχεας, με",  # noqa: RUF001
    ]
